...
export default function Home(props: HomeProps) {
  ...
  async function createPool(event: FormEvent) {
    ...
    try {
      ...
      alert('Bolão criado com sucesso, o codigo foi copiado para a area de transfeência !')
      setPoolTitle('')
    } catch (error) {
      console.log(error)
  ...
  return (
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
      <main>
        ...
        <form onSubmit={createPool} className="mt-10 flex gap-2">
          <input
            ...
            value={poolTitle}
          />
          <button type="submit" className="bg-yellow-500 px-6 py-4 rounded trex-gray-900 font-bold text-sm uppercase hover:bg-yellow-700" >Criar meu bolão</button>
        </form>
      ...
      <Image src={appPreviewImg} alt="Dois celulares exibindo uma previa do app"
        quality={100}
      />
    </div>
...
//   //Fazendo as requisições executarem em paralelo nao dependo terminar uma depois a outra
